...
var FinancialCategory = /* @__PURE__ */ ((FinancialCategory2) => {
  ...
  FinancialCategory2["SPONSORS"] = "sponsors";
  FinancialCategory2["TRANSFER_IN"] = "transfer_in";
  FinancialCategory2["TRANSFER_OUT"] = "transfer_out";
  FinancialCategory2["PRIZE"] = "prize";
  FinancialCategory2["SALARY"] = "salary";
  FinancialCategory2["STAFF_SALARY"] = "staff_salary";
  FinancialCategory2["STADIUM_MAINTENANCE"] = "stadium_maintenance";
...
function registerIpcHandlers() {
  ...
  ipcMain.handle("start-match", async (_, matchId) => {
    try {
  ...
  ipcMain.handle("pause-match", async (_, matchId) => {
    try {
  ...
  ipcMain.handle("resume-match", async (_, matchId) => {
    try {
  ...
  ipcMain.handle("simulate-match-minute", async (_, matchId) => {
    try {
  ...
  ipcMain.handle("simulate-full-match", async (_, matchId) => {
    try {
  ...
  ipcMain.handle("get-match-state", async (_, matchId) => {
    try {
  ...
  ipcMain.handle("simulate-matches-of-date", async (_, date) => {
    try {

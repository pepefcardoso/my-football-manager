...
import type { Competition, CompetitionStanding, Team } from "../../domain/models"; // Adicionado Team
...
function StandingsPage() {
    ...
    const currentSeasonId = 1; // TODO: Pegar do GameState via window.electronAPI.getGameState()
                                ...
                                <tbody className="divide-y divide-slate-800">
                                    {standings.map((row, index) => (
                                        <tr key={row.id} className="hover:bg-slate-800/50">
                                            <td className={`p-4 text-center font-mono ${index < 4 ? "text-blue-400 border-l-2 border-l-blue-500" :
                                                index > standings.length - 4 ? "text-red-400 border-l-2 border-l-red-500" :
                                                    "text-slate-500"
                                                }`}>
                                                {index + 1}
                                            </td>

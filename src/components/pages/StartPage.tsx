...
function StartPage() {
    ...
    const handleLoadGameConfirm = async (filename: string) => {
        ...
        try {
            ...
            if (result.success) {
                logger.info("Save carregado no banco. Recuperando estado...");
                ...
                if (gameState && gameState.playerTeamId) {
                    ...
                    if (myTeam) {
                        ...
                        throw new Error("Time do jogador não encontrado.");
                    }
                } else {
    ...
    return (
        <div className="h-screen w-full bg-slate-950 flex relative overflow-hidden font-sans selection:bg-emerald-500/30">
            ...
            <div className="w-full lg:w-5/12 xl:w-4/12 flex flex-col justify-center p-12 z-10 bg-slate-950/80 backdrop-blur-sm border-r border-slate-800 shadow-2xl">
                ...
                <div className="z-10 max-w-md p-6 bg-slate-900/50 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl translate-y-12 animate-in fade-in slide-in-from-bottom-10 duration-1000">
                    ...
                    <ul className="space-y-3 text-slate-300 text-sm">
                        ...
                        <li className="flex gap-2">
                         ...
                         <li className="flex gap-2">
                            <span className="text-emerald-500">➜</span>
                            UI da Start Page completamente refeita.
                        </li>
                    </ul>
                </div>
            </div>

...
const PlayerStatusBadges = memo(({ player }: PlayerStatusBadgesProps) => {
    ...
    <div className="overflow-x-auto rounded-lg border border-slate-800 bg-slate-900/50">
      <table className="w-full text-left text-sm">
        <thead className="bg-slate-900 text-xs uppercase font-semibold text-slate-400">
          <tr>
            <th scope="col" className="p-4 min-w-[200px]">
              Nome
            </th>
            <th scope="col" className="p-4 min-w-[60px]">
              Pos
            </th>
            ...
            <th scope="col" className="p-4 min-w-[140px]">
              Condição
            </th>
            <th scope="col" className="p-4 text-center min-w-[80px]">
              Moral
            </th>
            <th scope="col" className="p-4 text-right min-w-[120px]">
              Salário
            </th>
            <th scope="col" className="p-4 text-center min-w-[120px]">
              Status
            </th>
          </tr>
        </thead>
...
export default memo(PlayerTable, (prevProps, nextProps) => {
